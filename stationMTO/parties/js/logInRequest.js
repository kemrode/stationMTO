...
const url = 'http://192.168.137.22:5000/API/RASPBERRY/SIGNUP/<string:xLastName>/<string:xFirstName>/<string:xCity>/<string:xEmail>/<string:xPassword>';
...
submitBTN.addEventListener('click', ()=> {
    ...
    isInputEmpty(nom);
    arrayOfInputElementsForDataBase['xFirstName']=surname.value;
    surname = document.querySelector('#surname');
    isInputEmpty(surname);
    arrayOfInputElementsForDataBase['xLastName']=nom.value;
...
function transfer(arrayOfInputElementsForDataBase) {
    $.ajax({
    type: "POST",
    url: `http://192.168.137.22:5000/API/RASPBERRY/SIGNUP/${arrayOfInputElementsForDataBase['xLastName']}/${arrayOfInputElementsForDataBase['xFirstName']}/${arrayOfInputElementsForDataBase['xCity']}/${arrayOfInputElementsForDataBase['xEmail']}/${arrayOfInputElementsForDataBase['xPassword']}`,
